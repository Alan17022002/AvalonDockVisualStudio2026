...
namespace AvalonDock.VS2026Test.ViewModels
{
	internal class Workspace : ViewModelBase
	{
		...
		{
			new Tuple<string, Theme>(nameof(Vs2026DarkTheme),new Vs2026DarkTheme()),
			new Tuple<string, Theme>(nameof(Vs2026LightTheme),new Vs2026LightTheme()),
			new Tuple<string, Theme>(nameof(Vs2026BlueTheme),new Vs2026BlueTheme())
		};
		...
		private void SwitchExtendedTheme()
		{
			...
			{
				case "Vs2026DarkTheme":
					Application.Current.Resources.MergedDictionaries[0].Source = new Uri("pack://application:,,,/MLib;component/Themes/DarkTheme.xaml");
					Application.Current.Resources.MergedDictionaries[1].Source = new Uri("pack://application:,,,/VS2026Test;component/Themes/DarkBrushsExtended.xaml");
					break;
				case "Vs2026LightTheme":
					Application.Current.Resources.MergedDictionaries[0].Source = new Uri("pack://application:,,,/MLib;component/Themes/LightTheme.xaml");
					Application.Current.Resources.MergedDictionaries[1].Source = new Uri("pack://application:,,,/VS2026Test;component/Themes/LightBrushsExtended.xaml");
					break;
				case "Vs2026BlueTheme":
					//TODO: Create new color resources for blue theme
					Application.Current.Resources.MergedDictionaries[0].Source = new Uri("pack://application:,,,/MLib;component/Themes/LightTheme.xaml");
					Application.Current.Resources.MergedDictionaries[1].Source = new Uri("pack://application:,,,/VS2026Test;component/Themes/BlueBrushsExtended.xaml");
					break;
				default:
					break;
			}
